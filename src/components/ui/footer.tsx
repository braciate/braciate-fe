        ...
        <div className="flex flex-col py-4 items-center md:items-end">
          <div className="flex mb-4 space-x-8 sm:space-x-6 md:space-x-4 lg:space-x-6 md:mb-2">
            <Link
              ...
              className={`flex items-center justify-center w-10 h-10 bg-white rounded-full md:w-8 md:h-8 p-1.5 ${styles.footer} hover:fill-white`}
            >
            ...
            <Link
              href="https://www.tiktok.com/@braciate2024?_t=8qdscUsAb6w&_r=1"
              target="_blank"
              rel="noopener noreferrer"
              className={`flex items-center justify-center w-10 h-10 bg-white rounded-full md:w-8 md:h-8 p-1.5 ${styles.footer} hover:fill-white`}
            >
