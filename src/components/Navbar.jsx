...
const Navbar = () => {
  ...
  return (
    <nav className="navbar">
      ...
      {/* nav mobile */}
      <div
        className={`md:hidden flex justify-end fixed top-0 right-0 w-screen h-screen bg-transparent transform transition-transform duration-300 ease-in-out ${
          isOpen ? "translate-x-0" : "translate-x-full"
        } `}
        onClick={toggleSlide}
      >
        <div
          className={`z-50 flex-col justify-around w-3/4 h-screen gap-2 p-8 text-2xl md:text-3xl tracking-wider bg-white text-end slide-nav`}
        >
