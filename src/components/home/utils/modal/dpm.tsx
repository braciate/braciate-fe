...
export default function Dpm() {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex justify-center items-center px-12 tab:px-32 text-white-Normal font-Amiko gap-10">
         <Link href="/dpm/favorite"><Image
            src={bestfavorite}
            alt="Favorite item"
            className="rounded-md w-56 cursor-pointer"
          /></Link>
        <div className="inset-0 rounded-3xl p-3"
          style={{ backgroundImage: `url(${BgDpm?.src || BgDpm})`, 
        ...
        />
        <div className="">
            <Link href="/dpm/aspirative"><div className=" cursor-pointer  border-2 border-white rounded-3xl px-1 py-9 flex flex-col items-center justify-center ">
