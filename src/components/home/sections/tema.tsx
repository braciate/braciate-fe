...
const EventTheme: FC = () => {
  return (
    <main className="w-full h-full bg-black py-[9%] flex flex-col items-center justify-center relative bg-cover bg-center object-cover">
      ...
      <div
        className="font-jaoren flex gap-2 text-5xl sm:text-6xl md:text-7xl tracking-wider z-10 relative w-max h-auto"
        data-aos="fade-up"
      >
      ...
      />
      <p
        className="font-poppins font-light md:text-[18px] z-10 sm:text-xl text-xs text-center w-[70%] max-w-[550px] md:mt-[-80px] mt-[-30px]"
        data-aos="zoom-in"
      >
