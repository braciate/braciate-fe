        ...
        <div className="flex flex-col items-center">
          <div className="flex justify-center items-center">
            ...
            <div data-aos="fade-up">
              <div className="flex gap-3 text-7xl mx-4 tracking-wider relative w-max h-auto scale-[.6] sm:scale-90 md:scale-100">
                  ...
                  >
                    <div className="flex items-center justify-center gap-6">
                      ...
                      <p className="text-[10px] w-40 text-center">
                        Parade Unit Kegiatan Mahasiswa akan menampilkan
                        penampilan kolaboratif dari UKM terpilih di tiga titik
                        sepanjang rute.
                      </p>
                    </div>
